// Additive Heretic content for BuddyDoom (approach A in HERETIC_HEXEN.md): a handful of
...
// to the corresponding BuddyDoom mobjtype (MT_H* monsters + MT_HARTI_* artifacts, plus a
