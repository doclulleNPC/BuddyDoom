...
// Rule-based coordinated monster tactics (flank / focus-fire / fall-back) for the
// offline L4D director -- no LLM.  Directs only AWAKE monsters (idle objective guards
// are left to wait); executed by A_LLMChase.  Call per-tic from the rule director.
// Deterministic / tic-locked.
